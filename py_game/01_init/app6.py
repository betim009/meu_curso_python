...
## Carregar imagem do ORC
orc_still = pygame.image.load("orc_idle.png")
orc_still = pygame.transform.scale(orc_still, (140, 140))
orc_still = pygame.transform.flip(orc_still, True, False)
...
while running:
    ...
    # Desenhar o orc na tela
    screen.blit(orc_still, (orc_x, orc_y))
